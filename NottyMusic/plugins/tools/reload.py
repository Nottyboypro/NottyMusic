...
from NottyMusic.utils.database import get_assistant, get_authuser_names, get_cmode
from NottyMusic.utils.decorators import ActualAdminCB, AdminActual, language
from NottyMusic.utils.formatters import alpha_to_int, get_readable_time
...
async def restartbot(client, message: Message, _):
    ...
    if chat_id:
        ...
        try:
            db[chat_id] = []
            await Notty.stop_stream_force(chat_id)
        except:
            pass
