...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("NottyMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("NottyMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("NottyMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("NottyMusic/assets/play_icons.png")
