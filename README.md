<h1 align="center">🎵 Notty Music Bot 🎵</h1>

<p align="center">
  <img src="https://telegra.ph/file/29808c1fd50add3b1bfc6.jpg" alt="Notty Music Logo" width="600" height="150">
</p>

<p align="center">
  <img src="https://img.shields.io/github/stars/TeamNotty/NottyMusic?style=for-the-badge&color=blue" alt="GitHub stars">
  <img src="https://img.shields.io/github/forks/TeamNotty/NottyMusic?style=for-the-badge&color=blue" alt="GitHub forks">
  <img src="https://img.shields.io/github/issues/TeamNotty/NottyMusic?style=for-the-badge&color=red" alt="GitHub issues">
  <img src="https://img.shields.io/github/license/TeamNotty/NottyMusic?style=for-the-badge&color=green" alt="GitHub license">
</p>
...
## 🚀 Deploy on Heroku 
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://dashboard.heroku.com/new?template=https://github.com/CyberPixelPro/NottyMusic)
...
4. **Clone the Repository**
   ```bash
   git clone https://github.com/CyberPixelPro/NottyMusic && cd NottyMusic
   ```
...
The Notty Music Bot offers a range of commands to enhance your music listening experience on Telegram:
...
For a full list of commands, use `/help` in [telegram](https://t.me/NottyBeatzBot).

---

### 🔄 Updates & Support

Stay updated with the latest features and improvements to Notty Music Bot:
...
We welcome contributions to the Notty Music Bot project. If you'd like to contribute, please follow these steps:
...
Thanks to all the contributors, supporters, and users of the Notty Music Bot. Your feedback and support keep us going!
